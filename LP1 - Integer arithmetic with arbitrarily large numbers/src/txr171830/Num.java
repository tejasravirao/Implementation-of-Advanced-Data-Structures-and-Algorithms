...
public class Num implements Comparable<Num> {
     ...
     * Takes a string s as parameter, with a number in decimal,
     * and creates the Num object representing that number in the chosen base.
     * */
    public Num(String s)
    {
        int count = 9;
    ...
    /**Calculating the array length of Num.
     * */
    ...
    * */
    ...
    /**Constructor for Num class. Initialize the Long array
     * with size.
     * */
    ...
    /** Constructor for Initializing Num with another Num.
     * */
    private Num(Num a) {
    ...
    /** Sum of two numbers a and b. Sum stored as Num.
     * */
    ...
    /** Calculate a-b. Difference stored as Num.
     * */
    ...
    /**Helper method to compute difference. Called in subtract()
     * method.
     * */
    ...
    /** Product of two numbers a and b. Product a*b is stored as Num.
     * */
    ...
    /** Helper Method. Perform multiplication.
     * */
    ...
    /**Shift after Multiplication to add to previous sum.
     * */
    ...
    /** Helper method. Power calculation. Used in Infix and Postfix evaluation.
     * */
    ...
    private static Num modulus(Num a, Num b) {
        ...
        if(b.compareTo(start) == 0 || b.compareTo(start) < 0){
            return null;
        }
        else if ( a.compareTo(start) == 0 || b.compareTo(new Num("1")) == 0)
            return start;
    ...
    // Use binary search to calculate square root of a.
    ...
    /** Return base used for calculations.
     * */
    public long base() {
        return base;
    }
    ...
    /**Perform calculation of the two operands.
     * */
    ...
    /**Helper Method. Precedence to evaluate Infix expression.
     * */
    ...
    /** Helper method. Used in Infix Evaluation.
     * */
